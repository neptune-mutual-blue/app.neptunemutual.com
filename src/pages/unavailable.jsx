  ...
  return (
    <main className='bg-white'>
      ...
      <Container className='py-28'>
        ...
        />
        <h2 className='my-6 font-bold leading-10 text-center text-h3'>
        ...
        <form autoComplete='off' className='max-w-md mx-auto mt-6'>
          ...
          <button
            type='submit'
            className='block w-full px-10 py-5 mt-6 font-bold uppercase rounded-lg bg-4e7dd9 text-EEEEEE text-h5'
          >
            subscribe
          </button>
        </form> */}
