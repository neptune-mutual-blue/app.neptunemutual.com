        ...
        >
          <Container>
            ...
            <p className="text-para mt-3 max-w-prose">
              Neptune Mutual provides you with guaranteed stablecoin liquidity
              to reduce your risk exposure by hedging against possible capital
              risks and smart contract vulnerabilities.
            </p>
          </Container>
        </div>
