...
export const ActiveReportSummary1 = ({ incidentReport, resolvableTill }) => {
  ...
  return (
    <>
      <OutlinedCard className="grid gap-5 grid-cols-3 bg-white">
        {/* Left half */}
        <div className="pb-0 md:pb-6 p-6 md:p-10 border-r border-B0C4DB flex-1 col-span-3 md:col-span-2">
        ...
        <div className="col-span-3 md:col-auto order-2">
          {reportingEnded ? (
            <ResolveIncident
        ...
        {/* Right half */}
        <div className="pt-0 p-6 md:p-10 col-span-3 md:col-auto">
