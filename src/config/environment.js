...
export const getGraphURL = (networkId) => {
  if (networkId === 3) {
    return "https://api.thegraph.com/subgraphs/id/QmfWGpv66b6e9ZK5VFiAX8DcjCuMTBHwuvquD5NVwCh4NF";
  }

  if (networkId === 42) {
    return "https://api.thegraph.com/subgraphs/id/QmfGeNBjkfaGVsfSS3WzXnmYAHgbvsXBXVAKnWHjbvVp7F";
  }
