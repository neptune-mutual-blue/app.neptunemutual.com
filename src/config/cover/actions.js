 ...
 */
export const getActions = (i18n, networkId) => {
  return {
    purchase: {
      ...
      getHref: (coverKey, productKey) => { return Routes.PurchasePolicy(coverKey, productKey, networkId) },
      action: 'purchase'
    },
    'add-liquidity': {
      ...
      getHref: (coverKey, _productKey) => { return Routes.ProvideLiquidity(coverKey, networkId) },
    ...
    report: {
      ...
      getHref: (coverKey, productKey) => { return Routes.ReportNewIncident(coverKey, productKey, networkId) },
      action: 'new-report'
    },
    claim: {
      ...
      getHref: (_coverKey, _productKey) => { return Routes.MyActivePolicies(networkId) },
      action: 'claim'
    }
  }
}
