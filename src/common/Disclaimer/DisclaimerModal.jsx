    ...
    >
      <ModalWrapper className='max-w-5xl bg-FEFEFF'>
        ...
        >
          ...
          <p><Trans>Neptune provides the marketplace, protocol and its products on a “as-is” basis and disclaim any warranties of merchantability, fitness for a particular purpose or any warranties arising from course of performance.</Trans></p>
          <p><Trans>Neptune does not guarantee that the marketplace, protocol or any products on the marketplace are bug-free, risk-free, error-free and/or free from any exploits. Further, Neptune does not warrant that any errors on the marketplace, protocol or products are correctable or will be correctable. </Trans></p>
          ...
          <p><Trans>Please be advised that the use of the dApp by individuals who are residents or citizens of the United States and its territories, or who qualify as a <a className='underline text-4e7dd9' href='https://en.wikipedia.org/wiki/United_States_person' target='_blank' rel='noreferrer'>US Person</a> and a <a className='underline text-4e7dd9' href='https://www.lawinsider.com/dictionary/us-taxpayer' target='_blank' rel='noreferrer'>US Taxpayer</a>, is strictly forbidden. Any attempt to access or use the product by such individuals may be in violation of our terms of service, applicable laws and regulations, and may result in legal consequences. We shall not be held liable for any damages, losses, or legal repercussions resulting from the prohibited use of the dApp by individuals from these regions. It is the responsibility of all potential users to ensure that they comply with all applicable laws and regulations before using the product.<br /><br />To see the Standard&nbsp;Terms and Conditions&nbsp;of the marketplace please click on the following <a className='underline text-4e7dd9' href='https://neptunemutual.com/docs/usage/standard-terms-and-conditions-versions/' target='_blank' rel='noreferrer'>link</a>.</Trans></p>
          ...
          <p><Trans>Neptune Mutual Association is not involved in the transactions between parties in the Neptune Mutual marketplace and has no control over the respective parties and no responsibility or liabilities on the transactions or any dealing between these parties, including but not limited to any settlement of the transactions or any background check, verification procedures, or due diligence  against any parties or  entities.  The Cover Creator understands and acknowledges that the respective parties have their own responsibilities to conduct any due diligence on their counterparties, if necessary, and to conduct all risk analysis or risk management against these counterparties.</Trans></p>

          <h3 className='font-semibold text-md'><Trans>Beta version</Trans></h3>
