  ...
  return (
    ...
    >
      <ModalWrapper className='max-w-5xl bg-FEFEFF'>
        <Title
          className='flex items-center font-semibold font-inter text-h4'
    ...
    >
      <ModalWrapper className='max-w-5xl bg-FEFEFF'>
        ...
        >
          ...
          <h3 className='font-semibold font-inter text-h5'><Trans>Neptune Mutual Association</Trans></h3>
          ...
          <h3 className='font-semibold font-inter text-h5'><Trans>Beta version</Trans></h3>
          ...
          <h3 className='font-semibold font-inter text-h5'><Trans>Disclaimer Subject to change</Trans></h3>
