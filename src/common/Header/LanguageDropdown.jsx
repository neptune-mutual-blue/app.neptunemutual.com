        ...
        >
          ...
          >
            <div className='flex items-center pb-4 mb-1 text-sm'>
              ...
              <input
                autoComplete='off'
                className='w-full placeholder-[#B0C4DB] text-black outline-0 h-6 max-w-[250px] font-inter'
                  ...
                  {({ selected, active }) => (
                    <span
                      className={classNames(
                        'truncate p-2 flex justify-between items-center text-xs font-medium tracking-normal font-inter leading-4',
