      ...
      <ModalWrapper className='relative p-6 pb-10 md:pt-12 bg-f6f7f9 md:px-14 md:pb-11 rounded-3xl w-max z-60'>
        ...
        <div>
          <div className='text-center'>
            <p className='leading-4 font-inter text-h5'>Ethereum gas fees too high?</p>
            <p className='mt-2 font-semibold font-inter text-h4'>Use Neptune Mutual on Arbitrum</p>
          </div>
          ...
          <div className='mt-4'>
            ...
            <a
              ...
              onClick={handleClosePopup}
            >
              <span className='font-semibold leading-5 uppercase font-inter text-h5'>Switch to arbitrum</span>
