    ...
    <div className="col-span-3 row-start-2 md:col-auto md:row-start-auto">
      <CoverResolutionSources coverInfo={coverInfo}>
        ...
        <div
          ...
          title={
            formatCurrency(convertFromUnits(totalLiquidity), router.locale).long
          }
        >
          <span className="">
          ...
          <strong className="font-bold text-right">
            {
              formatCurrency(convertFromUnits(totalLiquidity), router.locale)
                .short
            }
          </strong>
        </div>
        <div
          ...
          title={
            formatCurrency(convertFromUnits(reassuranceAmount), router.locale)
              .long
          }
        >
          <span className="">
