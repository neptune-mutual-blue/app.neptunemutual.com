    ...
    <Transition appear show={isOpen} as={React.Fragment}>
      ...
      >
        <div className='flex items-end justify-center min-h-full'>
          ...
          <Transition.Child as={React.Fragment}>
            <div className='relative bottom-0 flex flex-col items-center max-w-full px-8 py-6 overflow-hidden text-left rounded-b-none xs:mx-1 sm:max-w-xl md:max-w-2xl bg-F5F9FC backdrop-blur-3xl md:flex-row text-h6 md:bottom-8 rounded-t-2xl md:rounded-b-2xl'>
