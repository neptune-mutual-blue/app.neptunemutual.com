...
describe("DisabledInput component", () => {
  ...
  test("should render value and input with cursor-not-allowed class", () => {
    ...
    let element = screen.getByText(mockProps.value);
    let unit = screen.getByText(mockProps.unit);
    let cursor = screen.container.getElementsByClassName("cursor-not-allowed");
