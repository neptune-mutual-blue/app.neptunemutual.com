  ...
  return (
    <div className='flex flex-col gap-2'>
      <div className='flex flex-row items-center gap-1'>
        ...
        <InfoTooltip infoComponent={`${formatCurrency(tokenValue, router.locale, '', true, true).long} NPM emission per block.`} className='text-[11px] px-2 py-0.75 bg-opacity-100 max-w-none'>
          <span><InfoCircleIcon className='w-4 h-4' /></span>
        </InfoTooltip>
      </div>
