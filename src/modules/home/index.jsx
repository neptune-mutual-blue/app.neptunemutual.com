...
export default function HomePage () {
  return (
    <>
      ...
      <a className='flex justify-center px-4 pt-16 pb-0 mx-auto md:pb-8 max-w-7xl sm:px-6 md:px-8' href='https://neptunemutual.com/docs/neptune-mutual-nfts/' target='_blank' rel='noreferrer'>
