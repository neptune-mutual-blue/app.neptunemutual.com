class DateLib {
  ...
  static dateToUTC(date) {
    const currentTime = date instanceof Date ? date : new Date();
    const isoTime = new Date();

    isoTime.setUTCDate(currentTime.getDate());
    isoTime.setUTCFullYear(currentTime.getFullYear());
    isoTime.setUTCHours(currentTime.getHours());
    isoTime.setUTCMilliseconds(currentTime.getMilliseconds());
    isoTime.setUTCMinutes(currentTime.getMinutes());
    isoTime.setUTCMonth(currentTime.getMonth());
    isoTime.setUTCSeconds(currentTime.getSeconds());
