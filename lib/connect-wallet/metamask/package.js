...
import { getMetaMaskProvider } from '@/lib/connect-wallet/providers'
...
export class InjectedConnector extends AbstractConnector {
  ...
  handleChainChanged (chainId) {
    ...
    this.emitUpdate({ chainId, provider: getMetaMaskProvider() })
  }
  ...
  handleNetworkChanged (networkId) {
    ...
    this.emitUpdate({ chainId: networkId, provider: getMetaMaskProvider() })
  }
