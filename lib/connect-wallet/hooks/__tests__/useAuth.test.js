...
describe('Connect wallet Hooks', () => {
  ...
  test('should return default value', async () => {
    ...
    const { result } = renderHook(() => { return useAuth(testData.network.networkId, notify) }
    )
  ...
  test('No Connector', async () => {
    ...
    renderHook(() => { return useAuth(testData.network.networkId, notify) })
  ...
  test('Connect to Unknown', async () => {
    ...
    mockHooksOrMethods.useWeb3React(() => { return { ...testData.account, connector } })
    const { result } = renderHook(() => { return useAuth(testData.network.networkId, notify) }
    )
  ...
  test('Connect to Unknown Network with Error and no setup', async () => {
    ...
    const { result } = renderHook(() => { return useAuth(undefined, notify) })
