...
import { getBitKeepWalletProvider } from '@/lib/connect-wallet/providers'
...
export class NoEthereumProviderError extends Error {
  constructor () {
    ...
    this.message = 'No BitKeep provider was found.'
  }
}
...
export class InjectedConnector extends AbstractConnector {
  ...
  handleChainChanged (chainId) {
    ...
    this.emitUpdate({ chainId, provider: getBitKeepWalletProvider() })
  }
  ...
  handleNetworkChanged (networkId) {
    ...
    this.emitUpdate({ chainId: networkId, provider: getBitKeepWalletProvider() })
  }

  async activate () {
    const provider = getBitKeepWalletProvider()
  ...
  async getProvider () {
    return getBitKeepWalletProvider()
  }
