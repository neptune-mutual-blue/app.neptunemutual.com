...
describe('metamask: setupNetwork', () => {
  ...
  test('Ethereum not provided', async () => {
    mockGlobals.console.error()
...
describe('Wallet', () => {
  ...
  test('connect Binance with Error', async () => {
    global.BinanceChain = {
      switchNetwork: async () => { return Promise.reject(new Error('An error occurred when connecting to binance')) }
    }
...
describe('Web3', () => {
  ...
  test('getProvider: should throw error', async () => {
    expect(() => { return getProvider(networkId + 1) }).toThrow(TypeError)
  })
  ...
  test('getLibrary: should throw error', async () => {
    expect(() => { return getLibrary('') }).toThrowError()
  })
  ...
  test('getSigner: should throw error', async () => {
    expect(() => { return getSigner('', account) }).toThrowError()
  })
  ...
  test('getProviderOrSigner: without library and account and networkid', async () => {
    expect(() => { return getProviderOrSigner(undefined, undefined, undefined) }).toThrow(
      TypeError
    )
  })
})
