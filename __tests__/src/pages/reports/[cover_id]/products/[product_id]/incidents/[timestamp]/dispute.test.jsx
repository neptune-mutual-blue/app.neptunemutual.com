...
import DisputeFormPage from "@/src/pages/reports/[cover_id]/products/[product_id]/incidents/[timestamp]/dispute";
...
jest.mock("@/src/modules/reporting/ReportingHero", () => {
  return {
    ReportingHero: () => {
      return <div data-testid="reporting-hero"></div>;
    },
  };
});
...
jest.mock("@/src/modules/reporting/NewDisputeReportForm", () => {
  return {
    NewDisputeReportForm: () => {
      return <div data-testid="new-dispute-report-form"></div>;
    },
  };
});
